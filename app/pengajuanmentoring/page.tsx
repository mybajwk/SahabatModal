...
const FundingBasicPage: React.FC<FundingBasicPageProps> = ({}) => {
  ...
  useEffect(() => {
    const calculateProgress = () => {
      let filledFields = 0;
      const totalFields = 3; // Jumlah field yang perlu diisi untuk progress penuh
    ...
    // Trigger ulang setiap kali salah satu field berubah
    calculateProgress();
      ...
      >
        <section className="flex w-full justify-between mx-[120px]">
          ...
          >
           <button
              type="button" 
              // onClick={() => navigate('/dashboard-pengusaha')} 
          ...
          <div className="flex-1 flex flex-col gap-5 justify-center items-center">
            ...
            <div className="flex flex-row w-full">
                        ...
                        <FormItem className='flex flex-col'>
                          ...
                          <Popover>
                            <PopoverTrigger asChild>
                              ...
                              >
                              <CalendarIcon className="mr-2 h-4 w-4 text-[#9EA2AD]" />
                                {field.value ? (
              ...
              <div className="flex pb-10 justify-end items-center w-full">
                    <Button
                      className="rounded-full px-6 sm:px-10 text-[20px] sm:text-[30px] py-4 sm:py-6 text-white font-lexend"
                      style={{
