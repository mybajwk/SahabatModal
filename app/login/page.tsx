    ...
    <div className="flex h-screen">
      <div
        ...
        style={{
          ...
          opacity: 0.75,
          background:
            "conic-gradient(from -68deg at 50.89% 26.15%, #6B90E8 0deg, #3E3183 308.53201389312744deg)",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <div className="text-center p-10">
          <h1 className="text-3xl font-bold mb-4">
            Koneksi, Inkubasi, Ekspansi
          </h1>
          <p className="text-lg" style={{ fontSize: "42px" }}>
            with
          </p>
          <h2
        ...
        <div className="w-3/4">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onBlur={(e) =>
                (e.target.style.color = username ? "#0010A4" : "initial")
              }
